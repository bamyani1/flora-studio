...
export function GalleryFullBleed({ album }: GallerySectionProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Text overlay */}
        <div className="fullbleed-text absolute inset-0 flex items-center justify-center bg-[var(--color-surface)]/20 backdrop-blur-[2px] transition-all duration-700 group-hover/bleed:bg-[var(--color-surface)]/10 group-hover/bleed:backdrop-blur-none">
