...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Studio Bahar covering ownership of site content, permitted use, inquiries, liability limitations, and governing law.",
};
      ...
      <section className="px-[var(--container-padding-x)] pt-[var(--header-height)] pb-[var(--section-padding-y)]">
        <div className="mx-auto max-w-[var(--max-width-content)] pt-[var(--space-16)]">
          ...
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted md:text-lg">
            These terms govern use of the Studio Bahar website itself. They do not replace any
